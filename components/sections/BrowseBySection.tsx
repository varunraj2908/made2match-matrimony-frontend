export default function BrowseBySection() {
  return (
    <section className="bg-white border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 md:flex-row md:gap-8 lg:px-6">
